...
(function () {
    ...
    function exportBuyOrder() {
        ...
        // Expose buy-list helpers for modal onclick handlers (BP exists when this is called)
        window.BP.buyListCopyClipboard = buyListCopyClipboard;
        window.BP.buyListExportCsv = buyListExportCsv;
        window.BP.buyListExportText = buyListExportText;
