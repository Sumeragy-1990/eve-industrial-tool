...
async def calculate_build_cost(
    ...
    # NOTE: Rig bonuses require per-category matching (large ship rig nur für große Schiffe).
    # Bis das implementiert ist, werden Rig-Boni pauschal summiert -> zu starke Reduktion.
    # Nutzer: Rig-Namen leer lassen ("none") für korrekte ME-Werte.
