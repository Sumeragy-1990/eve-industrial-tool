...
async def calculate_build_cost(
    ...
    _RIG_FALLBACK = {"none": 0.0, "t1": 0.02, "t2": 0.024,
        ...
        # T1 Manufacturing Rigs
        "m_basic_large_ship_mat_1": 0.01,
        "m_basic_medium_ship_mat_1": 0.01,
        "m_basic_small_ship_mat_1": 0.01,
        "m_basic_capital_ship_mat_1": 0.01,
        "m_basic_adv_component_mat_1": 0.01,
        "m_basic_component_mat_1": 0.01,
        # T2 Manufacturing Rigs
        "m_rig_large_ship_mat_1": 0.0192,
        "m_rig_medium_ship_mat_1": 0.0192,
        "m_rig_small_ship_mat_1": 0.0192,
        "m_rig_capital_ship_mat_1": 0.0192,
        "m_rig_adv_component_mat_1": 0.0192,
        "m_rig_component_mat_1": 0.0192,
    }
    ...
    rig_mat_bonus = min(rig_mat_bonus + structure_mat_bonus, 0.15)
    ...
    for item in body.cart_items:
        ...
        for m in mats:
            ...
            if m_is_reaction:
                ...
                adjusted = max(1, math.ceil(base_qty * max(0.01, me_factor) * (1.0 - rig_mat_bonus)))
