    ...
    async function _fetchBuildCostsForOrder(order) {
        ...
        try {
            ...
            if (resp.ok) {
                ...
                // Ruff _fetchBuildCostsForOrder für jede Sub-Order auf
                ...
                // Propagation: Sub-Order Total → Parent Material
                console.log("[BP] Propagating Sub-Order costs... subs=" + _productionOrders.filter(function(x){return x.type==='sub';}).length);
